...
等待程序重新编译运行完毕之后，在浏览器输入 [http://localhost:3000/user](http://localhost:3000/user) 访问即可看到：【**你好，世界！**】
...
![](https://picbed-1258935921.cos.ap-guangzhou.myqcloud.com/20231023171834.png)
